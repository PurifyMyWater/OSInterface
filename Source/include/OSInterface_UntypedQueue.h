...
public:
     ...
     */
    [[nodiscard]] virtual bool isFull() = 0;
     ...
     *
     * @param message Pointer to buffer to store the received message. The message buffer must be of size messageSize
     * specified during queue creation.
